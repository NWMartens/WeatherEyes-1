...
class WebpageMongo:
    ...
    def Single_Day_Inquiry_Hourly_Obs(self,date, collection, userid):
      """
      Take argument date format Jan 02 2021 1 PM    
      """
    ...
    def Interval_Inquiry_Hourly_Obs(self, date, collection, userid):
      """
      Takes argument date format Jan 01 2021 1 PM - Jan 02 2021 2 PM
      """
    ...
    def Interval_Inquiry(self, start_date, end_date, collection, userid):
      """
      Takes argument date format list of format:
      start_date = ['Jan', '01', '2021']
      end_date = ['Jan', '02', '2021']
      """
    ...
    def Forecast_Inquiry(self, date, time, service_prov, timeinterval):
      ...
      if timeinterval == "Daily":
          for x in results:
              ...
              Docs = {"Date" : x["Date"], "Precipitation_Probability" : x["PrecipitationProb"] , "Description" : x["Description"], "MinTemp" : x["MinTempF"], "MaxTemp" : x["MaxTempF"]} # Will eventually code to user preference
